...
{
    public sealed class SchedulerServiceV2
    {
       ...
       static readonly string dbConnectionString = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        ...
        private static readonly Lazy<SchedulerServiceV2> lazy = new Lazy<SchedulerServiceV2>(() => new SchedulerServiceV2());
        ...
        public static SchedulerServiceV2 Instance
        {
            get
            {
                return lazy.Value;
